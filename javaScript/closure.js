...
function bagPack() {
  ...
  return function () {
    //this function has the acess to the outer scopes
    console.log(secret);
  };
}
bagPack()(); //this is a scret text

const doremonBag = bagPack();
doremonBag(); //this is a scret text

console.log(doremonBag); //[Function (anonymous)] // this is a function ready to be called
